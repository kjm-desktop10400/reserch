...
int main(void)
{
    ...
    fputs("set key bottom left spacing 2.5 offset 25, 5\n", pipe);
    ...
    */
    ...
    fputs("input = \"..\\\\data\\\\NtoN_ac_gain_and_phase.vcsv\"\n", pipe);

    fputs(" plot   input skip 6 using 1 : 2 axis x1y1 with lines title \"gain proposed\" \n", pipe);
    fputs(" replot input skip 6 using 3 : 4 axis x1y2 with lines dt 3 title \"phase proposed\" \n", pipe);

    fputs("input2 = \"..\\\\data\\\\previous_ac.vcsv\"\n", pipe);

    fputs(" replot input2 skip 6 using 1 : 2 axis x1y1 with lines title \"gain previous\" \n", pipe);
    fputs(" replot input2 skip 6 using 3 : 4 axis x1y2 with lines dt 3 title \"phase previous\" \n", pipe);
