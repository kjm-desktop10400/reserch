...
int main(void)
{
    ...
    */
    ...
    fprintf(pipe, "plot   input skip 6 using (($1) * 1e9) : 2 with lines title \"1\"  \n");
    fprintf(pipe, "replot input skip 6 using (($3) * 1e9) : 4 with lines title \"2\"  \n");
