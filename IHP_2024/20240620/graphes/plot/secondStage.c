...
//    fputs("set my2tics 30 \n", pipe);
    ...
    */
    ...
    fputs("input = \"..\\\\data\\\\secondStage.vcsv\"\n", pipe);

    fprintf(pipe, "plot     input skip 6 using 1 : 2 axis x1y1 with lines title \"gain\" \n");
    fprintf(pipe, "replot   input skip 6 using 1 : 4 axis x1y2 with lines title \"phase\" \n");
