...
int main(void)
{
    ...
    */
    ...
    fputs("LTS = \"..\\\\data\\\\secondStageSubCont.txt\"\n", pipe);
    fputs("virtuoso = \"..\\\\data\\\\secondStage.vcsv\"\n", pipe);

    fprintf(pipe, "plot     LTS skip 1 using 1 : 2 with lines title \"LTS\" \n");
    fprintf(pipe, "replot   virtuoso skip 6 using 1 : 2  with lines title \"IHP\" \n");
