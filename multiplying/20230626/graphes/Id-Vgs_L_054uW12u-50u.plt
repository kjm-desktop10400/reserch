...
set ylabel "sqrt I [mA^{1/2}]" font "Arial,30" offset -8,0
...
plot "Id-Vgs_L_054u.vcsv" skip 6 using 1  : (sqrt(($2 )) * y_scale) with lines title "" #sprintf("W : %d um", 12 )
replot ""                 skip 6 using 3  : (sqrt(($4 )) * y_scale) with lines title "" #sprintf("W : %d um", 14 )
replot ""                 skip 6 using 5  : (sqrt(($6 )) * y_scale) with lines title "" #sprintf("W : %d um", 16 )
replot ""                 skip 6 using 7  : (sqrt(($8 )) * y_scale) with lines title "" #sprintf("W : %d um", 18 )
replot ""                 skip 6 using 9  : (sqrt(($10)) * y_scale) with lines title "" #sprintf("W : %d um", 20 )
replot ""                 skip 6 using 11 : (sqrt(($12)) * y_scale) with lines title "" #sprintf("W : %d um", 22 )
replot ""                 skip 6 using 13 : (sqrt(($14)) * y_scale) with lines title "" #sprintf("W : %d um", 24 )
replot ""                 skip 6 using 15 : (sqrt(($16)) * y_scale) with lines title "" #sprintf("W : %d um", 26 )
replot ""                 skip 6 using 17 : (sqrt(($18)) * y_scale) with lines title "" #sprintf("W : %d um", 28 )
replot ""                 skip 6 using 19 : (sqrt(($20)) * y_scale) with lines title "" #sprintf("W : %d um", 30 )
replot ""                 skip 6 using 21 : (sqrt(($22)) * y_scale) with lines title "" #sprintf("W : %d um", 32 )
replot ""                 skip 6 using 23 : (sqrt(($24)) * y_scale) with lines title "" #sprintf("W : %d um", 34 )
replot ""                 skip 6 using 25 : (sqrt(($26)) * y_scale) with lines title "" #sprintf("W : %d um", 36 )
replot ""                 skip 6 using 27 : (sqrt(($28)) * y_scale) with lines title "" #sprintf("W : %d um", 38 )
replot ""                 skip 6 using 29 : (sqrt(($30)) * y_scale) with lines title "" #sprintf("W : %d um", 40 )
replot ""                 skip 6 using 31 : (sqrt(($32)) * y_scale) with lines title "" #sprintf("W : %d um", 42 )
replot ""                 skip 6 using 33 : (sqrt(($34)) * y_scale) with lines title "" #sprintf("W : %d um", 44 )
replot ""                 skip 6 using 35 : (sqrt(($36)) * y_scale) with lines title "" #sprintf("W : %d um", 46 )
replot ""                 skip 6 using 37 : (sqrt(($38)) * y_scale) with lines title "" #sprintf("W : %d um", 48 )
replot ""                 skip 6 using 39 : (sqrt(($40)) * y_scale) with lines title "" #sprintf("W : %d um", 50 )
